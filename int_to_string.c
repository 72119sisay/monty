...
/**
 * get_int - gets a character pointing to new string containing int
...
/**
 * _abs - gets the absolute value of n integer
...
/**
 * get_number_len - gets length of buffer needed for an unsigned int
